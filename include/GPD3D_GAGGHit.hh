...
#ifndef GPD3D_GAGGHIT_HH
#define GPD3D_GAGGHIT_HH
...
//! Gas cell hit class.
class GPD3D_GAGGHit : public G4VHit
{
  public:

    GPD3D_GAGGHit();
    GPD3D_GAGGHit(const GPD3D_GAGGHit&);
    virtual ~GPD3D_GAGGHit();

    const GPD3D_GAGGHit& operator=(const GPD3D_GAGGHit&);
    G4int operator==(const GPD3D_GAGGHit&) const;
...
typedef G4THitsCollection<GPD3D_GAGGHit> GPD3D_GAGGHitsCollection;

extern G4ThreadLocal G4Allocator<GPD3D_GAGGHit>* GPD3D_GAGGHitAllocator;

inline void* GPD3D_GAGGHit::operator new(size_t)
{
  if(!GPD3D_GAGGHitAllocator)
      GPD3D_GAGGHitAllocator = new G4Allocator<GPD3D_GAGGHit>;
  return (void *) GPD3D_GAGGHitAllocator->MallocSingle();
}

inline void GPD3D_GAGGHit::operator delete(void *hit)
{
  GPD3D_GAGGHitAllocator->FreeSingle((GPD3D_GAGGHit*) hit);
}

#endif //GPD3D_GAGGHIT_HH
