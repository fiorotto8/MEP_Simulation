...
#include "GPD3D_GAGGSD.hh"

GPD3D_GAGGSD::GPD3D_GAGGSD(const G4String& name,
...
GPD3D_GAGGSD::~GPD3D_GAGGSD()
{}

void GPD3D_GAGGSD::Initialize(G4HCofThisEvent* hce)
{
  m_hitsCollection = new GPD3D_GAGGHitsCollection(SensitiveDetectorName,
                                                   collectionName[0]);
  G4int hcID = G4SDManager::GetSDMpointer()->GetCollectionID(collectionName[0]);
  hce->AddHitsCollection(hcID, m_hitsCollection);
}

G4bool GPD3D_GAGGSD::ProcessHits(G4Step* aStep, G4TouchableHistory*)
{
  ...
  GPD3D_GAGGHit* newHit = new GPD3D_GAGGHit();
...
void GPD3D_GAGGSD::EndOfEvent(G4HCofThisEvent*)
{
}
