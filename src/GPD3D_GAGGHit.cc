...
G4ThreadLocal G4Allocator<GPD3D_GAGGHit>* GPD3D_GAGGHitAllocator=0;

GPD3D_GAGGHit::GPD3D_GAGGHit() :
  G4VHit(),
  m_trackID(-1),
  m_parentID(-1),
  m_stepNum(-1),
...
GPD3D_GAGGHit::GPD3D_GAGGHit(const GPD3D_GAGGHit& right) :
  G4VHit()
{
...
const GPD3D_GAGGHit& GPD3D_GAGGHit::operator=(const GPD3D_GAGGHit& right)
{
  m_trackID = right.m_trackID;
  m_parentID = right.m_parentID;
  m_stepNum = right.m_stepNum;
...
G4int GPD3D_GAGGHit::operator==(const GPD3D_GAGGHit& right) const
{
